...
res <- Load_china(first.year = 2015,
                  ...
                  Mortality_prop = 'D:\\Obj 3 model Yuyang\\CAM 0511\\R data\\prop_CAM_HR_nweight_0317.RDS',#
                  Mortality_SE = F,
...
res <- Load_china(first.year = 2015,
                  ...
                  TP_interval = 2,
                  Adjust_prop_year = NULL,# Adjust by which year?
                  Mortality_prop = 'D:\\Obj 3 model Yuyang\\CAM 0511\\R data\\prop_CAM_HR_nweight_0317.RDS',#注意路径和文件
                  Mortality_SE = F,
                  Mortality = CVD_calendar.Mortality,# each cvd
